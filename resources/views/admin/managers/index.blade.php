...
@extends('layouts.app')
@section('title') Listado de Jefes de obra @endsection
                    ...
                    <table id="responsive-datatable" class="table dt-responsive nowrap">
                        ...
                        <tbody>
                            @foreach ($data as $row)
                                <tr>
                                    <td>
                                        <img src="{{ asset('uploads/pic_profile/'.$row->pic_profile) }}" alt="profile" style="max-width: 100%;height: 40px;border-radius: 2003pc;width: 40px;">
                                    </td>
                                    <td>
                                        {{ $row->name }}
                                    </td>
